...
var contAddress = '0x1765e75bbF6cE8C43a13eD91C032A137d102f4d4';
var refAdd = '0x9d737E06A8Fa553d18Cf12826a07e802a31019f4';
...
console.clear();
console.log(getDate());
console.log('Re-toast Amount: ', rebakeAmount, 'Frequency: ', timer / 1000);
...
// Rebake Beans
function autoBake() {
    console.log('Last Re-toast Time: ', rebakeTime);
    estimateGas();
    contract.methods.beanRewards(addr).call(function (error, result) {
        if (error) {
            ...
            if (withdraw == 'y' && loop < withdrawDay) {
                console.log('Eating every', withdrawDay, 'Iterations')
                console.log('Re-toast', loop, '/', withdrawDay - 1);
            }
            if (loop == withdrawDay) {
                console.log("Waiting to eat toast");
            }
